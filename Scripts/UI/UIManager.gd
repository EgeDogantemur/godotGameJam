...
@onready var time_label: Label = $GameHUD/TopLeft/HUDCard/Margin/VBox/TimeLabel
@onready var dash_label: Label = $GameHUD/TopLeft/HUDCard/Margin/VBox/DashPanel/Margin/DashLabel
